...
import br.com.jsn.entidade.Mensagem;
 ...
 */
@Stateless
@Path("br.com.jsn.entidade.mensagem")
public class MensagemFacadeREST extends AbstractFacade<Mensagem> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Mensagem entity) {
        super.edit(entity);
    }
    ...
    public Mensagem find(@PathParam("id") Integer id) {

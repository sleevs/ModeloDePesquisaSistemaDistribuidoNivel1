...
import br.com.jsn.entidade.Documento;
 ...
 */
@Stateless
@Path("br.com.jsn.entidade.documento")
public class DocumentoFacadeREST extends AbstractFacade<Documento> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Documento entity) {
        super.edit(entity);
    }
    ...
    public Documento find(@PathParam("id") Integer id) {
